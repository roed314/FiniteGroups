// Usage: ls /scratch/grp/subtex/quoin/ | parallel -j120 --timeout 120 magma -b base:=/scratch/grp/subtex/ label:={1} QuoTex.m
...
for H in subs do
    ...
    Qtex := GroupName(Q: prodeasylimit:=2, wreathlimit:=0, TeX:=true);
    PrintFile(oname, Sprintf("%o.%o|%o", label, short_label, Qtex));
end for;
quit;
