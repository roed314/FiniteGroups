...
intrinsic IsInSmallGroupDatabase(D::DB["Grp:small"], o::RngIntElt) -> BoolElt
...
intrinsic IsSolvable(D::DB["Grp:small"], o::RngIntElt, n::RngIntElt) -> BoolElt
...
intrinsic IsSoluble(D::DB["Grp:small"], o::RngIntElt, n::RngIntElt) -> BoolElt
{Return true iff SmallGroup(D, o, n) is soluble}
    _sg_check_order(o);
    if (IsSolvableOrder(o)) then
       return true;
...
intrinsic SmallGroupIsSolvable(D::DB["Grp:small"], o::RngIntElt, n::RngIntElt) -> BoolElt
...
intrinsic SmallGroupIsSoluble(D::DB["Grp:small"], o::RngIntElt, n::RngIntElt) -> BoolElt
{Return true if SmallGroup(D, o, n) is soluble (does not load the group)}
    _sg_check_order(o);
    requirerange n, 1, NumberOfSmallGroups(o);
    return IsSoluble(D, o, n);
...
intrinsic SmallGroupIsInsolvable(D::DB["Grp:small"], o::RngIntElt, n::RngIntElt) -> BoolElt
{Return true if SmallGroup(D, o, n) is insoluble (does not load the group)}
    return not SmallGroupIsSoluble(D, o, n);
end intrinsic;

intrinsic SmallGroupIsInsoluble(D::DB["Grp:small"], o::RngIntElt, n::RngIntElt) -> BoolElt
{Return true if SmallGroup(D, o, n) is insoluble (does not load the group)}
    return not SmallGroupIsSoluble(D, o, n);
end intrinsic;
...
intrinsic NumberOfSmallGroups(D::DB["Grp:small"], n::RngIntElt) -> RngIntElt
...
intrinsic SmallGroupDatabaseLimit(D::DB["Grp:small"]) -> RngIntElt
...
intrinsic SmallGroup(D::DB["Grp:small"], o::RngIntElt, Predicate::Program :
                     Search := "All") -> Grp
...
intrinsic SmallGroup(D::DB["Grp:small"], Orders::SeqEnum, Predicate::Program : 
		     Search := "All") -> Grp
{Returns the first group with order in Orders which satisfies the 
predicate and the search condition specified by Search (see above).}
...
intrinsic SmallGroup(D::DB["Grp:small"], o::RngIntElt : Search := "All") -> Grp
{Returns the first group of order o which satisfies the search condition 
specified by Search (see above).}
...
intrinsic SmallGroups(D::DB["Grp:small"], o::RngIntElt :
...
intrinsic SmallGroups(D::DB["Grp:small"], Orders::SeqEnum : 
		      Search := "All", Warning := true) -> List
...
intrinsic SmallGroups(D::DB["Grp:small"], o::RngIntElt, Predicate::Program :
		      Search := "All", Warning := true) -> List
...
intrinsic SmallGroups(D::DB["Grp:small"], Orders::SeqEnum, Predicate::Program :
		      Search := "All", Warning := true) -> List
{As above, but with a list of orders.}
...
function RelatorsFromCode(code, size, gens)
    ...
    mi := Maximum(f) - 1;
    n := code;
    if #Set(f) gt 1 then // size is prime?
      n, n1 := Quotrem(n, mi^l);
      indices := [];
      for i in [1 .. l] do
...
{Decode a small groups data code representing a pc-group}
    ...
    return quo<F | RelatorsFromCode(code, size, gens): Class := "PolycyclicGroup">;
end intrinsic;
