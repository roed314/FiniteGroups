...
cyclo_values   | jsonb      | a list character values in the order of the conjugacy classes.  Individual character values are given as lists of integers giving coefficients w.r.t. a power basis of zeta_n
...
faithful       | boolean    | Whether the corresponding homomorphism is injective
nt             | int[]   | the pair [n,t] where nTt is the smallest permutation representation containing the character
values         | int[]      | a list character values
